...
# ── 1. Prefer agy-hud Node runtime if installed ─────────────────────────────
HUD_JS="$HOME/.gemini/config/plugins/agy-hud/dist/agy-hud.js"
if command -v node >/dev/null 2>&1 && [ -f "$HUD_JS" ]; then
    printf "%s" "$input" | node "$HUD_JS" statusline
    exit $?
fi

# ── 2. Standalone Pure Bash + jq 2-Line HUD Fallback ────────────────────────
...
make_bar() {
    ...
    local col="\033[38;2;74;222;128m"
    if [ "$pct" -ge 90 ]; then
        col="\033[38;2;248;113;113m"
    elif [ "$pct" -ge 70 ]; then
        col="\033[38;2;251;191;36m"
    fi
    local track="\033[38;2;71;85;105m"
    local reset="\033[0m"
...
# ANSI colors matching agy-hud
c_blue="\033[1;38;2;56;189;248m"
c_sep="\033[38;2;100;116;139m │ \033[0m"
c_dir="\033[1;38;2;251;191;36m"
c_git="\033[1;38;2;192;132;252m"
c_state="\033[1;38;2;74;222;128m"
c_label="\033[1;38;2;226;232;240m"
c_muted="\033[38;2;148;163;184m"
reset="\033[0m"

case "$agent_state" in
    running|executing) c_state="\033[1;38;2;251;146;60m" ;;
    thinking)          c_state="\033[1;38;2;34;211;238m" ;;
    auth)              c_state="\033[1;38;2;248;113;113m" ;;
esac

# ── Assemble Line 1 ──────────────────────────────────────────────────────────
#  3.8 Flash Med |  Pro │  net-worth-tracker │  main │ ● Idle
line1="${c_blue} ${model} |  ${plan}${reset}${c_sep}${c_dir} ${cwd_name}${reset}${c_sep}${c_git} ${git_branch}${reset}${c_sep}${c_state}● ${state_name}${reset}"
